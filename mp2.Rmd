...
incumbency_party <- contested_contributions %>%
  ...
  scale_y_continuous(name = "Total Donations", breaks = c(0e+00, .5e+08, 1e+08, 1.5e+08, 2e+08, 2.5e+08, 3e+08, 3.5e+08), labels = c("$0", "$50", "$100", "$150", "$200", "$250", "$300", "$350")) +
...
, breaks = c(0e+00, 1e+06, 2e+06, 3e+06, 4e+06, 5e+06, 6e+06, 7e+06), labels = c("$0", "$1 Million", "$2 Million", "$3 Million", "$4 Million", "$5 Million", "$6 Million", "$7 Million")
